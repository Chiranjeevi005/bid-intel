  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
      ...
      <div className="mb-6">
        ...
        >
          <UploadCloud className="w-10 h-10 text-gray-400 mx-auto mb-2" strokeWidth={1.5} />
      ...
      {file && status !== 'SUCCESS' && (
        <div className="flex items-center justify-between bg-gray-50 p-4 rounded-md border border-gray-200 mb-6">
          <div className="flex items-center truncate mr-4">
            <FileText className="w-4 h-4 text-gray-500 mr-2 shrink-0" strokeWidth={1.75} />
        ...
        <div className="mb-6 p-4 rounded-md bg-green-50 text-green-800 border border-green-200 text-sm flex justify-between items-center">
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <span className="text-green-700">{successFilename}</span> is ready for analysis.
            </div>
          </div>
          ...
          {analysisStatus === 'PROCESSING' && (
            <div className="ml-4 text-indigo-600 font-semibold text-sm flex items-center">
              <Loader2 className="w-4 h-4 animate-spin mr-2 text-indigo-600" strokeWidth={2.5} />
      ...
      <div className="flex justify-end">
        <button
          ...
          className="rounded-md bg-gray-900 px-6 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-gray-800 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
        >
          {status === 'UPLOADING' && <Loader2 className="w-4 h-4 animate-spin" strokeWidth={2.5} />}
